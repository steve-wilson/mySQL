...
static SYMBOL symbols[] = {
  ...
  { "GTID",		SYM(GTID_SYM)},
  { "GTID_EXECUTED",	SYM(GTID_EXECUTED)},
  { "GRANT",		SYM(GRANT)},
  { "GRANTS",	        SYM(GRANTS)},
  { "GROUP",		SYM(GROUP_SYM)},
  ...
  { "INDEX",		SYM(INDEX_SYM)},
  { "INDEXES",		SYM(INDEXES)},
  { "INFER_SAMPLE_SIZE",	SYM(INFERENCE_SAMPLE_SIZE_SYM)},
  { "INFILE",		SYM(INFILE)},
  ...
  { "SCHEMA_MERGE",      SYM(SCHEMA_MERGE_SYM)},
